    ...
    <section id="hero" className="crawl-hero" aria-label="About Zachary Stybel">
      ...
      <div className="crawl-wrapper">
        <div className="crawl-text" onAnimationEnd={onComplete}>
          ...
          <p>I mainly worked with Python and gained hands-on experience with Docker for local development, unit/integration testing, designing distributed systems, and database/schema design.</p>
          ...
          <p>Outside of work and school, I usually play Rainbow Six Siege, watch football (both of them), go to the gym, or chef it up in the kitchen.</p>
